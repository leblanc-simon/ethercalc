SocialCalc.Constants : {
    ...
    TCpanesliderClass: "",
    s_panesliderTooltiph: "Glisser pour vérouiller la fenêtre verticalement",
    ...
    s_TCTDFthumbstatusPrefixv: "Ligne ",
    TCTDFStopOffseth: -30,
    TCTDFSleftOffseth: 0,
    s_TCTDFthumbstatusPrefixh: "Colonne ",
    TooltipOffsetX: 2,
    TooltipOffsetY: 10,
    TDpopupElementClass: "",
    ...
    s_loc_align_left: "Alignement à gauche",
    s_loc_align_right: "Alignement à droite",
    ...
    s_loc_display_clipboard_in: "Afficher le presse-papiers dans le ",
    s_loc_down: "Bas",
    s_loc_edit: "Modifier",
    ...
    s_loc_move_insert: "Déplacer en insérant",
    s_loc_move_paste: "Déplacer en collant",
    ...
    s_loc_this_is_aXbrXsample: "Ceci est un<br>test",
    s_loc_top: "Haut",
    ...
    s_fdef_ATAN: "Fonction trigonometrique arctangente. ",
    ...
    s_fdef_COUNTBLANK: 'Compte le nombre de blancs. (Note: "" n\'est pas un blanc.) ', // vérifier que le \' passe bien
    ...
    s_fdef_DAVERAGE: "Calcul la moyenne des champs spécifiés qui satisfont le critère. ",
    ...
    s_fdef_DSTDEV: "Retourne l'écart-type d'une population des valeurs numériques dans les champs spécifiés qui satisfont le critère. ",
    s_fdef_DSTDEVP: "Retourne l'écart-type des valeurs numériques dans les champs spécifiés qui satisfont le critère. ",
    ...
    s_farg_subs: "texte1, vieuxtexte, nouveautexte [, occurrence]",
    s_farg_sumif: "range1, critère [, range2]", // ??
    s_farg_hms: "heure, minute, seconde",
    s_farg_txt: "texte",
    s_farg_vlookup: "valeur, range, colonne, [rangelookup]", // ??
