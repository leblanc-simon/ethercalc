SocialCalc.Constants = {
    ...
    s_InternalError: "Erreur interne de Framacalc (probablement un bug interne) : ",
    ...
    s_loc_clear_socialcalc_clipboard: "Nettoyer le presse-papier de Framacalc ",
    ...
    s_fdef_EXACT: 'Retourne "true" si les valeurs sont exactement les mêmes, inclant la case, le type, etc. ',
    s_fdef_EXP: "Retourne e élevé à puissance spécifiée. ",
    ...
    s_fdef_FV: "Retourne la valeur future des paiements itérés d'un montant investi à un taux donné pour un nombre spécifié de périodes, avec comme option facultative la valeur présente present value (0 par défaut) et le type de paiements (par défaut 0 = à la fin de la période, 1 = au début de la période). ",
    ...
    s_fdef_LEFT: "Retourne le nombre spécifié de caractères d'une châine de texte. Si le nombre est omis, sa valeur est 1. ",
    ...
    s_fdef_VAR: "Retroune la variance d'une population des valeurs numériques spécifiées. ",
    ...
    s_farg_dfunc: "databaserange, fieldname, critere-de-sélection",
    s_farg_ddb: "coût, salvage, durée-de-vie, période [, facteur]",
    s_farg_find: "chaîne1, chaîne2 [, début]",
    s_farg_fv: "taux, n, paiement, [pv, [type-de-paiement]]",
    s_farg_hlookup: "valeur, sélection, row, [rangelookup]",
    ...
    s_farg_match: "valeur, sélection, [selection-de-recherche]",
    ...
    s_farg_txt: "texte",
    s_farg_vlookup: "valeur, sélection, colonne, [selection-de-recherche]",
