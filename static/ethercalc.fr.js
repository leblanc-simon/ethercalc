SocialCalc.Constants = {
    ...
    s_escUnknownSheetCmd: "Commande sur les feuilles inconnue : ",
    ...
    defaultLinkFormatString: '<span style="font-size:smaller;text-decoration:none !important;background-color:#66B;color:#FFF;">Lien</span>',
    ...
    defaultDisplayTRUE: "VRAI",
    defaultDisplayFALSE: "FAUX",
    ...
    s_inputboxdisplaymultilinetext: "[Multi-line text: Cliquez sur la droite de l'icône pour éditer]",
    ...
    ietUnknownFunction: "Fonction inconnue ",
    CH_radius1: 29,
    CH_radius2: 41,
    s_CHfillAllTooltip: "Remplir les contenus et les formats bas/droite",  // ?? 
    s_CHfillContentsTooltip: "Remplir les contenus seulement bas/droite",  // ?? 
    s_CHmovePasteAllTooltip: "Déplacer les contenus et les formats",
    ...
    s_CHindicatorOperationLookup: {
        Fill: "Remplir",
        FillC: "Remplir le contenu",
        Move: "Déplacer",
        MoveI: "Faire glisser",
        MoveC: "Déplacer le contenu",
        MoveIC: "Faire glisser le contenu"
    },
    ...
    TCpanesliderClass: "",
    s_panesliderTooltiph: "Glisser pour vérouiller la fenêtre verticallement",
    s_panesliderTooltipv: "Glisser pour vérouiller la fenêtre horizontalement",
    ...
    s_loc_align_center: "Alignement Centré",
    s_loc_align_left: "Alignement Gauche",
    s_loc_align_right: "Alignement Droite",
    s_loc_alignment: "Alignement",
    s_loc_audit: "Suivi de modifications",
    s_loc_audit_trail_this_session: "Suivre les modifications de cette session",
    s_loc_auto: "Automatique",
    s_loc_auto_sum: "Somme automatique",
    s_loc_auto_wX_commas: "Auto w/ virgule",
    ...
    s_loc_borders_off: "Bordures désactivées",
    s_loc_borders_on: "Bordures activées",
    s_loc_bottom: "Bas",
    ...
    s_loc_category: "Categorie",
    s_loc_center: "Centrer",
    s_loc_clear: "Nettoyer",
    s_loc_clear_socialcalc_clipboard: "Nettoyer le presse-papiers de SocialCalc ",
    s_loc_clipboard: "Presse-papiers",
    s_loc_color: "Couleur",
    ...
    s_loc_display_clipboard_in: "Afficher le presse-papiers dedans",
    s_loc_down: "Bas",
    s_loc_edit: "Modifier",
    s_loc_existing_names: "Noms existants",
    s_loc_family: "Famille",
    s_loc_fill_down: "Remplir en Bas",
    s_loc_fill_right: "Remplir à Droite",
    s_loc_font: "Police",
    s_loc_format: "Format",
    s_loc_formula: "Formule",
    s_loc_function_list: "Liste de fonctions",
    ...
    s_loc_link: "Lien",
    s_loc_link_input_box: "Lien des données de la case",
    s_loc_list: "Liste",
    s_loc_load_socialcalc_clipboard_with_this: "Charger le presse-papier de SocialCalc avec ceci",
    s_loc_major_sort: "Tri majeur",
    s_loc_manual: "Manuel",
    s_loc_merge_cells: "Fusionner des cellules",
    s_loc_middle: "Milier",
    s_loc_minor_sort: "Tri mineur",
    s_loc_move_insert: "Déplacer Insérer",
    s_loc_move_paste: "Déplacer Coller",
    s_loc_multiXline_input_box: "Case d'import multi-ligne",
    s_loc_name: "Nom",
    s_loc_names: "Noms",
    s_loc_no_padding: "Pas de remplissage",
    s_loc_normal: "Normal",
    s_loc_number: "Nombre",
    s_loc_number_horizontal: "Nombre Horizontal",
    s_loc_ok: "OK",
    s_loc_padding: "Remplissage",
    s_loc_page_name: "Nom de page",
    s_loc_paste: "Coller",
    s_loc_paste_formats: "Coller les formats",
    ...
    s_loc_save: "Enregister",
    s_loc_save_to: "Enregistrer sous",
    s_loc_set_cell_contents: "Définir le contenu de la cellule",
    ...
    s_loc_setXclear_move_from: "Définir/Nettoyer les déplacements depuis",
    s_loc_show_cell_settings: "Afficher les paramètres des cellules",
    s_loc_show_sheet_settings: "Afficher les paramètres des feuilles",
    s_loc_show_in_new_browser_window: "Afficher dans une nouvelle de votre navigateur",
    s_loc_size: "Taille",
    s_loc_socialcalcXsave_format: "Format de sauvegarde de SocialCalc",
    s_loc_sort: "Trier",
    s_loc_sort_: "Trier ",
    ...
    s_loc_this_is_aXbrXsample: "Ceci est un<br>échantillon",
    s_loc_top: "Haut",
    ...
    s_loc_XnewX: "[Nouveau]",
    s_loc_XnoneX: "[Aucun]",
    s_loc_Xselect_rangeX: "[choisissez la sélection]",
    ...
    s_FormatNumber_daynames: "Dimanche,Lundi,Mardi,Mercredi,Jeudi,Vendredi,Samedi".split(","),
    s_FormatNumber_daynames3: "Dim,Lun,Mar,Mer,Jeu,Ven,Sam".split(","),
    s_FormatNumber_monthnames: "Janvier,Février,Mars,Avril,Mai,Juin,Juillet,Août,Septembre,Octobre,Novembre,Décembre".split(","),
    s_FormatNumber_monthnames3: "Jan,Fev,Mar,Avr,Mai,Jun,Jul,Aou,Sep,Oct,Nov,Dec".split(","),
    ...
    s_parseerrtwoops: "Erreur dans la formule (deux opérateurs innoportuns dans la chaîne)",
    ...
    s_parseerrmissingoperand: "Operande manquant. ", // nom masculin 
    ...
    s_calcerrnumericoverflow: "Overflow numérique", // à traduire ?? 
    s_sheetunavailable: "Feuille indisponible :",
    s_calcerrcellrefmissing: "Référence manquante à une cellule quand il y en a besoin.",
    s_calcerrsheetnamemissing: "Nom de la feuille manquant quand il y en a besoin.",
    ...
    s_fdef_ASIN: "Fonction trigonometrique arcsinus. ",
    s_fdef_ATAN: "Fonction trigonometrique arctan. ",
    s_fdef_ATAN2: "Fonction trigonometrique arctangente (le résultat est en radians). ",
    ...
    s_fdef_COUNTBLANK: 'Compte le nombre de blancs. (Note: "" ne compte pas comme un blanc.) ',
    ...
    s_farg_dt: "date",
    function_classlist: "all,stat,lookup,datetime,financial,test,math,text".split(","),
    s_fclass_all: "Tout",
    s_fclass_stat: "Statistiques",
    s_fclass_lookup: "Lookup",
    s_fclass_datetime: "Date & Heure",
